...
DevStackIO's [QR Code Generator](/tools/qr-generator) is **100% client-side, unlimited, no tracking, all formats free.**
...
**DevStackIO generates static codes only.**
...
- [QR Code Generator Library (node-qrcode)](https://github.com/soldair/node-qrcode)
- [ZXing — Multi-format 1D/2D barcode library](https://github.com/zxing/zxing)
---
...
- [Random Data Generation](/guides/tutorials/random-data-generation)
...
- [wifi-qr-generator](/tools/wifi-qr-generator)
