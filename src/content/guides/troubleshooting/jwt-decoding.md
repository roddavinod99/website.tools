...
#### Header Tab
- ✅ `alg` matches expectation (RS256 ≠ HS256)
...
| **EdDSA** | Ed25519 | Public/Private | Modern, fast, small | **Recommended for new systems**. No RNG needed. |
...
- [JWT Structure](/guides/concepts/jwt-structure) — Complete JWT reference
- [JWT Security Best Practices](/guides/best-practices/jwt-security) — Security deep dive
- [HMAC Authentication](/guides/best-practices/hmac-authentication) — API signing

## Tools

- [JWT Decoder](/tools/jwt-decoder) — Paste, inspect, verify. Zero upload, total privacy
...
It's likely a **nested JWT** (JWT inside JWT) or **JWE** (encrypted). Decoder handles both.
...
Check: `SameSite` cookies, CORS, `Authorization` header vs cookie, token storage.
---
