# IP Subnetting: Complete Guide to CIDR, Masks, and Network Planning
...
**Modern practice**: Ignore traditional classes (A/B/C), use CIDR exclusively.
...
### Broadcast Address (Network + all host bits = 1)
...
| CIDR | Netmask | Wildcard | Total IPs | Usable Hosts |
|------|---------|----------|-----------|--------------|
...
- [IPv6 Addressing](/guides/concepts/ipv6-addressing) — Deep dive on IPv6
- [CIDR Aggregation](/guides/references/cidr-aggregation) — Route summarization
- [VLAN Planning](/guides/tutorials/vlan-design) — Network segmentation

## Tools

- [IP Calculator](/tools/ip-calculator) — IPv4/IPv6, CIDR, netmask, wildcard, host range
...
- [ipv4-subnet-calculator](/tools/ipv4-subnet-calculator)
- [ipv6-calculator](/tools/ipv6-calculator)
