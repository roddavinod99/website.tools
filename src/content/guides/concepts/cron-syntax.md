# Cron Syntax: Complete Guide to Scheduling Expressions
...
Each field controls one unit of time, in order: minute (0-59), hour (0-23), day of month (1-31), month (1-12 or names), and day of week (0-6 or names).
...
**Important**: The day-of-month and day-of-week fields are combined differently across systems. Standard cron uses OR, but AWS EventBridge uses AND — a classic source of bugs.
...
- [Systemd Timers](/guides/concepts/systemd-timers) — Modern alternative
- [Timestamp Conversion](/guides/troubleshooting/timestamp-conversion) — Unix time ↔ human
- [Date Calculations](/guides/troubleshooting/date-calculations) — Business days, intervals

## Tools

- [Cron Expression Generator](/tools/cron-expression) — Visual builder, 5/6-field formats, Quartz/Spring/systemd, next run preview, validation
...
- [cron-expression](/tools/cron-expression)
