          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-[var(--color-border)]">
                ...
                <tr>
                  <td className="py-2 pr-4 font-mono text-xs">_dsio_visit</td>
                  <td className="py-2 pr-4">Necessary</td>
                  <td className="py-2 pr-4">Tracks an active browsing session so the site can count visitors (HttpOnly, first-party, never used for advertising or profiling)</td>
