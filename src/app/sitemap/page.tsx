            ...
            <ul className="space-y-2">
              {staticPages.map((p) => (
                <li key={p.href}>
                  <Link
                    href={p.href}
                    className="text-sm text-blue-700 dark:text-blue-400 hover:text-blue-800 transition-colors"
                  >
                    {p.title}
                  </Link>
                </li>
...
<div>
        ...
        <div className="mt-10 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] p-6">
          ...
          <Link
            href="/sitemap.xml"
            className="mt-2 inline-block text-sm text-blue-700 dark:text-blue-400 hover:text-blue-800 font-mono underline"
          >
            /sitemap.xml
          </Link>
        </div>
