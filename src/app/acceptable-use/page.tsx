        ...
        <div className="space-y-8 text-[var(--color-text-muted)]">
          ...
          <section id="5-security-and-integrity">
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <div className="mt-2 p-3 rounded-md bg-[var(--color-surface)] border border-[var(--color-border)]">
          ...
          <section id="9-reporting-violations">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="p-4 rounded-md bg-[var(--color-surface)] border border-[var(--color-border)] space-y-2">
