      ...
      <article className="prose mx-auto max-w-4xl">
        ...
        <div className="space-y-8 text-[var(--color-text-muted)]">
          <section id="1-conformance">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">1. Conformance Status</h2>
            <p className="mt-2">
          ...
          <section id="3-screen-readers">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">3. Screen Reader Support</h2>
            <ul className="mt-2 list-disc pl-6 space-y-1">
          ...
          <section id="4-visual">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">4. Visual Design & Contrast</h2>
            <ul className="mt-2 list-disc pl-6 space-y-1">
          ...
          <section id="5-content">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">5. Content & Media</h2>
            <ul className="mt-2 list-disc pl-6 space-y-1">
          ...
          <section id="6-limitations">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">6. Known Limitations</h2>
            <p className="mt-2">
          ...
          <section id="7-feedback">
            <h2 className="text-2xl font-bold text-[var(--color-text)]">7. Feedback & Contact</h2>
            <p className="mt-2">
