        ...
        <div className="space-y-8 text-surface-600 dark:text-dark-muted">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-dark-border">
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Processing Activity</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Lawful Basis (Art. 6)</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Details</th>
                  </tr>
                </thead>
          ...
          <section id="3-data-categories">
            ...
            <div className="mt-4 space-y-3">
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">A. Technical Data (Automatically Collected)</h3>
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">B. Analytics Data (Consent-Based)</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">C. Cookie & Preference Data</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">D. Contact Form Data (Voluntary)</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
          ...
          <section id="4-purpose">
            ...
            <div className="mt-4 space-y-4">
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">1. Service Delivery & Security (Art. 6(1)(f))</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">2. Analytics & Improvement (Art. 6(1)(a) — Consent)</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">3. Advertising (Art. 6(1)(a) — Consent)</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">4. Communication (Art. 6(1)(b)/(f))</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">5. Legal Compliance (Art. 6(1)(c))</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
          ...
          <section id="5-recipients">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-dark-border">
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Recipient</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Purpose</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Legal Basis</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Location</th>
                    <th className="py-2 text-left font-semibold text-surface-900 dark:text-dark-text">DPA Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-surface-200 dark:divide-dark-border">
                  <tr>
          ...
          <section id="6-international-transfers">
            ...
            <div className="mt-4 space-y-3">
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Standard Contractual Clauses (SCCs)</h3>
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">EU-US Data Privacy Framework</h3>
                <p className="mt-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Transfer Impact Assessments (TIAs)</h3>
                <p className="mt-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">No Transfer of Your Tool Data</h3>
                <p className="mt-1 text-sm">
          ...
          <section id="7-retention">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-dark-border">
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Data Category</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Retention Period</th>
                    <th className="py-2 text-left font-semibold text-surface-900 dark:text-dark-text">Basis</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-surface-200 dark:divide-dark-border">
          ...
          <section id="8-your-rights">
            ...
            <div className="mt-4 space-y-4">
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right of Access (Art. 15 GDPR, §1798.100 CCPA)</h3>
                <p className="mt-1 text-sm">Request confirmation of processing and a copy of your personal data.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right to Rectification (Art. 16 GDPR)</h3>
                <p className="mt-1 text-sm">Request correction of inaccurate or incomplete personal data.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right to Erasure / "Right to Be Forgotten" (Art. 17 GDPR, §1798.105 CCPA)</h3>
                <p className="mt-1 text-sm">Request deletion where data is no longer necessary, consent withdrawn, or processing unlawful.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right to Restriction (Art. 18 GDPR)</h3>
                <p className="mt-1 text-sm">Request limitation of processing pending verification or objection.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right to Data Portability (Art. 20 GDPR)</h3>
                <p className="mt-1 text-sm">Receive your data in a structured, commonly used, machine-readable format.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Right to Object (Art. 21 GDPR)</h3>
                <p className="mt-1 text-sm">Object to processing based on legitimate interest (Art. 6(1)(f)) or direct marketing.</p>
              </div>
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Rights re: Automated Decision-Making (Art. 22 GDPR)</h3>
            ...
            <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
              <h3 className="font-semibold text-surface-900 dark:text-dark-text">Supervisory Authority Complaint</h3>
              <p className="mt-1 text-sm">
          ...
          <section id="9-security">
            ...
            <div className="mt-4 space-y-3">
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Encryption & Transport</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Infrastructure & Resilience</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Organizational Measures</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Testing & Monitoring</h3>
                <ul className="mt-2 list-disc pl-6 space-y-1 text-sm">
          ...
          <section id="10-automated-decision">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">No Profiling</h3>
                <p className="mt-1 text-sm">
          ...
          <section id="11-cookies">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-dark-border">
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Category</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Cookies / Storage</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Purpose</th>
                    <th className="py-2 pr-4 text-left font-semibold text-surface-900 dark:text-dark-text">Duration</th>
                    <th className="py-2 text-left font-semibold text-surface-900 dark:text-dark-text">Consent</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-surface-200 dark:divide-dark-border">
          ...
          <section id="12-children">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
                <h3 className="font-semibold text-surface-900 dark:text-dark-text">Age Verification</h3>
                <p className="mt-1 text-sm">
          ...
          <section id="13-changes">
            ...
            <div className="mt-4 p-4 rounded-lg bg-surface-50 dark:bg-dark-surface border border-surface-200 dark:border-dark-border">
              <h3 className="font-semibold text-surface-900 dark:text-dark-text">Version History</h3>
              <dl className="mt-2 space-y-1 text-sm">
                <div className="flex flex-col sm:flex-row gap-2">
                  <dt className="font-semibold text-surface-900 dark:text-dark-text">2026-07-20 (v2.0)</dt>
                  <dd className="text-surface-600 dark:text-dark-muted">Full GDPR Art. 13/14 compliance; DPA reference; lawful basis table; international transfers; retention schedule; children's privacy.</dd>
                </div>
                <div className="flex flex-col sm:flex-row gap-2">
                  <dt className="font-semibold text-surface-900 dark:text-dark-text">2026-06-15 (v1.0)</dt>
                  <dd className="text-surface-600 dark:text-dark-muted">Initial version.</dd>
                </div>
              </dl>
            </div>
          </section>
