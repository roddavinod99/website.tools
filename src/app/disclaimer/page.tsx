    ...
    <div className="container py-12 md:py-16">
      <article className="prose mx-auto max-w-3xl">
        ...
        <div className="space-y-6 text-[var(--color-text-muted)]">
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">No Warranties</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">Educational Purposes</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">Tool Accuracy Disclaimer</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">AI-Generated Content Disclaimer</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">External Links Disclaimer</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-text)]">Changes to This Disclaimer</h2>
            <p className="mt-2">
