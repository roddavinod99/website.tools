  ...
  return (
    <section className="border-t border-[var(--color-border)]" aria-labelledby="tools-cta-heading">
      <div className="container py-16 md:py-20">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-md border border-[var(--color-border)] bg-[var(--color-bg)] p-8 text-center sm:p-12">
          <span className="flex h-12 w-12 items-center justify-center rounded-md bg-[var(--color-accent-soft)] text-blue-700 dark:text-blue-400">
