...
export function ResponsiveAd({ className = "", slot = "4567890123" }: AdPlaceholderProps) {
  ...
  if (IS_DEV) {
    return (
      <div
        className={`flex items-center justify-center rounded-lg border-2 border-dashed border-surface-300 bg-surface-50 dark:border-dark-border dark:bg-dark-surface min-h-[90px] ${className}`}
        role="img"
  ...
  return (
    <div ref={adRef} className={className} style={{ minHeight: 90 }}>
      <ins
