    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div>
          ...
          <select value={indent} onChange={(e) => setIndent(Number(e.target.value))} className="rounded-md border border-surface-200 bg-white px-3 py-2 text-sm dark:border-dark-border dark:bg-dark-surface dark:text-dark-text">
      ...
      {output && (
        <div>
          ...
          <pre className="rounded-md border border-surface-200 bg-surface-50 p-3 text-sm font-mono text-surface-900 overflow-auto max-h-60 dark:border-dark-border dark:bg-dark-surface dark:text-dark-text">{output}</pre>
