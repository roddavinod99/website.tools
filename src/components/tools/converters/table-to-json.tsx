    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={10}
          className="h-56 w-full rounded-md border border-surface-200 bg-surface-50 p-2.5 font-mono text-xs dark:border-dark-border dark:bg-dark-surface dark:text-dark-text"
        />
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        <button
          onClick={copy}
          disabled={!output}
          className="rounded-md bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 disabled:opacity-40 transition-colors"
        >
        ...
        <button
          onClick={download}
          disabled={!output}
          className="rounded-md border border-surface-200 px-4 py-2.5 text-sm font-medium text-surface-700 hover:bg-surface-50 disabled:opacity-40 dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-surface"
        >
          Download .json
        </button>
      </div>
