  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {showPreview && (
          <div>
            ...
            {showSource ? (
              <pre className="w-full rounded-md border border-surface-200 bg-surface-50 p-3 text-sm font-mono text-surface-900 dark:border-dark-border dark:bg-dark-surface dark:text-dark-text overflow-auto max-h-64 whitespace-pre-wrap min-h-[11rem]">{output || " "}</pre>
            ) : (
              <div className="w-full rounded-md border border-surface-200 bg-white p-3 text-sm text-surface-900 dark:border-dark-border dark:bg-dark-surface dark:text-dark-text overflow-auto max-h-64 min-h-[11rem] prose prose-sm dark:prose-invert"
      ...
      <div className="flex gap-2">
        <button onClick={copy} disabled={!output} className="rounded-md bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600 disabled:opacity-40 transition-colors" aria-label="Copy HTML">Copy HTML</button>
