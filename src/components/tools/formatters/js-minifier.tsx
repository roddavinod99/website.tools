  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button onClick={() => { setMode("minify"); minify(); }} className={`inline-flex items-center gap-1.5 rounded-md px-4 py-2 text-sm font-medium transition-colors ${mode === "minify" ? "bg-brand-500 text-white hover:bg-brand-600" : "border border-surface-200 text-surface-700 hover:bg-surface-50 dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-surface"}`}>
          <Minimize className="w-3.5 h-3.5" /> Minify
        </button>
        <button onClick={() => { setMode("beautify"); beautify(); }} className={`inline-flex items-center gap-1.5 rounded-md px-4 py-2 text-sm font-medium transition-colors ${mode === "beautify" ? "bg-brand-500 text-white hover:bg-brand-600" : "border border-surface-200 text-surface-700 hover:bg-surface-50 dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-surface"}`}>
