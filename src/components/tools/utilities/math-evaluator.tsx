    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-md border border-surface-200 bg-white px-3 py-2 text-sm font-mono text-surface-900 placeholder:text-surface-400 focus:outline-none focus:ring-2 focus:ring-brand-400 dark:border-dark-border dark:bg-dark-bg dark:text-dark-text dark:placeholder:text-dark-muted"
          />
          <button onClick={handleSubmit} className="rounded-md bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600 transition-colors">
            Evaluate
          </button>
        </div>
      </div>
      ...
      {result !== null && (
        <div className="rounded-md border border-surface-200 bg-surface-50 p-4 dark:border-dark-border dark:bg-dark-surface">
          ...
          <p data-testid="tool-output" className="text-2xl font-mono font-bold text-brand-600 dark:text-brand-400">{result}</p>
        </div>
      )}
          ...
          <div className="space-y-1 max-h-48 overflow-y-auto">
            {history.map((h) => (
              <button
                ...
                className="flex w-full items-center justify-between rounded-md border border-surface-200 bg-white px-3 py-2 text-sm font-mono hover:bg-surface-50 dark:border-dark-border dark:bg-dark-bg dark:hover:bg-dark-surface transition-colors"
              >
