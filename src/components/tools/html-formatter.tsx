...
export function HTMLFormatter() {
  ...
  const [, setErrorLine] = useState<number | null>(null);
  ...
  }, [input, indentW, wrapLen, preserveInline, selfClose, quoteStyle, removeCmts, removeEmptyAttrs, sortAttrs, formatEmbed]);
