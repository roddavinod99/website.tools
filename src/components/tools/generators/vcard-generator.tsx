...
export function VcardGenerator() {
  ...
  const inputCls =
    "w-full rounded-md border border-surface-200 bg-white p-2.5 text-sm dark:border-dark-border dark:bg-dark-bg dark:text-dark-text";
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea
        ...
        className="h-44 w-full rounded-md border border-surface-200 bg-surface-50 p-3 font-mono text-xs dark:border-dark-border dark:bg-dark-surface dark:text-dark-text"
      />
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="rounded-md bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 transition-colors"
        >
        ...
        <button
          ...
          className="rounded-md border border-surface-200 px-4 py-2.5 text-sm font-medium text-surface-700 hover:bg-surface-50 dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-surface transition-colors"
        >
          Download .vcf
        </button>
      </div>
