        ...
        {mode === "generate" && (
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button onClick={copyResult} disabled={!result} className="rounded-md border border-surface-200 px-4 py-2 text-sm text-surface-700 hover:bg-surface-50 disabled:opacity-40 dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-surface transition-colors">
