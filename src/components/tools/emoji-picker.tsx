...
const EMOJI_KEYWORDS: Record<string, string> = {
  ...
  "\u{1F612}": "unamitated face annoyed",
  ...
  "\u{1F1E6}\u{1F1E8}": "flag afghanistan af",
  "\u{1F1E6}\u{1F1EC}": "flag albania al",
  "\u{1F1E6}\u{1F1F7}": "flag algeria dz",
  "\u{1F1E7}\u{1F1E9}": "flag bangladesh bd",
  "\u{1F1E7}\u{1F1E7}": "flag barbados bb",
  "\u{1F1E7}\u{1F1EF}": "flag bhutan bt",
  "\u{1F1E7}\u{1F1F2}": "flag belize bz",
  "\u{1F1E7}\u{1F1F7}": "flag bolivia bo",
  "\u{1F1E7}\u{1F1F9}": "flag botswana bw",
  "\u{1F1E7}\u{1F1FC}": "flag belgium be",
  "\u{1F1E8}\u{1F1E6}": "flag canada ca",
  "\u{1F1E8}\u{1F1E8}": "flag chad td",
  "\u{1F1E8}\u{1F1ED}": "flag chile cl",
  "\u{1F1E8}\u{1F1EE}": "flag china cn",
  "\u{1F1E8}\u{1F1F0}": "flag colombia co",
  "\u{1F1E8}\u{1F1F1}": "flag cuba cu",
  "\u{1F1E8}\u{1F1F2}": "flag cameroon cm",
  "\u{1F1E8}\u{1F1F3}": "flag dr congo cd",
  "\u{1F1E8}\u{1F1F4}": "flag cyprus cy",
  "\u{1F1E8}\u{1F1F5}": "flag czech republic cz",
  "\u{1F1E8}\u{1F1F7}": "flag czechia cz",
  "\u{1F1E8}\u{1F1FA}": "flag curacao cw",
  "\u{1F1E8}\u{1F1F8}": "flag denmark dk",
  "\u{1F1E8}\u{1F1F9}": "flag djibouti dj",
  "\u{1F1E8}\u{1F1FB}": "flag dominican dm",
  "\u{1F1E8}\u{1F1FC}": "flag dominican do",
  "\u{1F1E8}\u{1F1FD}": "flag algeria dz",
  "\u{1F1E8}\u{1F1FE}": "flag ecuador ec",
  "\u{1F1E8}\u{1F1FF}": "flag egypt eg",
  "\u{1F1E9}\u{1F1EA}": "flag germany de",
  "\u{1F1E9}\u{1F1EC}": "flag djibouti dj",
  "\u{1F1E9}\u{1F1EF}": "flag denmark dk",
  "\u{1F1E9}\u{1F1F0}": "flag dominican do",
  "\u{1F1E9}\u{1F1F2}": "flag algeria dz",
  "\u{1F1E9}\u{1F1F4}": "flag ecuador ec",
  "\u{1F1EA}\u{1F1E8}": "flag egypt eg",
  "\u{1F1EA}\u{1F1EC}": "flag united kingdom gb uk",
  "\u{1F1EA}\u{1F1F7}": "flag france fr",
  "\u{1F1EA}\u{1F1F8}": "flag grenada gd",
  "\u{1F1EA}\u{1F1F9}": "flag georgia ge",
  "\u{1F1EA}\u{1F1FA}": "flag greece gr",
  "\u{1F1FA}\u{1F1F8}": "flag united states us america",
  "\u{1F1FB}\u{1F1EC}": "flag vietnam vn",
  "\u{1F1FB}\u{1F1EE}": "flag vanuatu vu",
  "\u{1F1FB}\u{1F1F3}": "flag venezuela ve",
  "\u{1F1FB}\u{1F1FA}": "flag virgin islands vi",
  "\u{1F1FC}\u{1F1EB}": "flag wallis wf",
  "\u{1F1FC}\u{1F1F8}": "flag samoa ws",
  "\u{1F1FD}\u{1F1F0}": "flag kosovo xk",
  "\u{1F1FE}\u{1F1EA}": "flag yemen ye",
  "\u{1F1FE}\u{1F1F9}": "flag south africa za",
  "\u{1F1FF}\u{1F1E6}": "flag zambia zm",
  "\u{1F1FF}\u{1F1F2}": "flag malaysia my",
