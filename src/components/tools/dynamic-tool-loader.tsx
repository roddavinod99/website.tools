...
const toolLoaders: Record<string, ToolLoader> = {
  ...
  "pdf-merger": () => import("./pdf/pdf-merger").then((m) => ({ default: m.PdfMerger })),
  "pdf-splitter": () => import("./pdf/pdf-splitter").then((m) => ({ default: m.PdfSplitter })),
  "image-to-pdf": () => import("./pdf/image-to-pdf").then((m) => ({ default: m.ImageToPdf })),
  "image-cropper": () => import("./image/image-cropper").then((m) => ({ default: m.ImageCropper })),
  "image-watermark": () => import("./image/image-watermark").then((m) => ({ default: m.ImageWatermark })),
  "pdf-compressor": () => import("./pdf/pdf-compressor").then((m) => ({ default: m.PdfCompressor })),
  "pdf-to-jpg": () => import("./pdf/pdf-to-jpg").then((m) => ({ default: m.PdfToJpg })),
  "image-to-svg": () => import("./image/image-to-svg").then((m) => ({ default: m.ImageToSvg })),
  "gif-maker": () => import("./image/gif-maker").then((m) => ({ default: m.GifMaker })),
  "image-collage": () => import("./image/image-collage").then((m) => ({ default: m.ImageCollage })),
  "color-picker": () => import("./image/color-picker").then((m) => ({ default: m.ColorPicker })),
  "json-escaper": () => import("./json/json-escaper").then((m) => ({ default: m.JsonEscaper })),
  "json-to-code": () => import("./json/json-to-code").then((m) => ({ default: m.JsonToCode })),
  "geohash-tool": () => import("./network/geohash-tool").then((m) => ({ default: m.GeohashTool })),
  "world-clock": () => import("./utilities/world-clock").then((m) => ({ default: m.WorldClock })),
};
