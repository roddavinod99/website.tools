...
const toolLoaders: Record<string, ToolLoader> = {
  ...
  "income-tax-calculator": () => import("./income-tax-calculator").then((m) => ({ default: m.IncomeTaxCalculator })),
  "us-income-tax-calculator": () => import("./us-income-tax-calculator").then((m) => ({ default: m.UsIncomeTaxCalculator })),
  "capital-gains-tax": () => import("./capital-gains-calculator").then((m) => ({ default: m.CapitalGainsCalculator })),
  "debt-payoff": () => import("./debt-payoff").then((m) => ({ default: m.DebtPayoff })),
  "credit-card-payoff": () => import("./credit-card-payoff").then((m) => ({ default: m.CreditCardPayoff })),
  "debt-to-income": () => import("./debt-to-income").then((m) => ({ default: m.DebtToIncome })),
  "break-even": () => import("./break-even").then((m) => ({ default: m.BreakEven })),
  "auto-loan": () => import("./auto-loan").then((m) => ({ default: m.AutoLoanCalculator })),
  "student-loan": () => import("./student-loan").then((m) => ({ default: m.StudentLoanCalculator })),
  "home-affordability": () => import("./home-affordability").then((m) => ({ default: m.HomeAffordabilityCalculator })),
  "rent-vs-buy": () => import("./rent-vs-buy").then((m) => ({ default: m.RentVsBuy })),
  "retirement-savings": () => import("./retirement-savings").then((m) => ({ default: m.RetirementSavingsCalculator })),
  "fixed-deposit": () => import("./fixed-deposit").then((m) => ({ default: m.FixedDepositCalculator })),
  "recurring-deposit": () => import("./recurring-deposit").then((m) => ({ default: m.RecurringDepositCalculator })),
  "down-payment-planner": () => import("./down-payment-planner").then((m) => ({ default: m.DownPaymentPlanner })),
  "tip-calculator": () => import("./tip-calculator").then((m) => ({ default: m.TipCalculator })),
  "vat-gst": () => import("./vat-gst-calculator").then((m) => ({ default: m.VatGstCalculatorTool })),
  "simple-interest": () => import("./simple-interest").then((m) => ({ default: m.SimpleInterestCalculator })),
  "inflation": () => import("./inflation").then((m) => ({ default: m.InflationCalculator })),
  "net-worth": () => import("./net-worth").then((m) => ({ default: m.NetWorthCalculator })),
  "emergency-fund": () => import("./emergency-fund").then((m) => ({ default: m.EmergencyFundCalculator })),
  "currency-converter": () => import("./currency-converter").then((m) => ({ default: m.CurrencyConverter })),
};
