  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <MoneyInput label="Principal amount" value={principal} onChange={setPrincipal} currency={currency} />
      ...
      {result ? (
        ...
        >
          <div>
            ...
            <p className="mt-1 text-2xl font-bold text-surface-900 dark:text-dark-text">{formatMoney(result.interest, currency)}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-1 text-xl font-semibold text-emerald-600 dark:text-emerald-400">{formatMoney(parseFloat(principal) || 0, currency)}</p>
          </div>
        </div>
      ) : (
